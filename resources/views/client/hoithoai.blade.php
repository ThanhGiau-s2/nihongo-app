...
<html lang="en">
    ...
    <div class="container canchinh">
        ...
        <div class="container content">
            <div class="dd"><h3><a href="">Trang chủ</a> >> <a href="dsbh">Danh sách bài học</a> >><a href="bai/{{$id}}"> Bài {{$id}} </a>>>Hội thoại</h3></div>
            <section>
                <div class="row">
                    <div class="col-md-8 col-xs-12 ctbh">
                        @foreach ($ht as $ht)  
                            ...
                            <div class="hinhdaidien">
                                <img src="upload/hoithoai/{{$ht->hinhdaidien}}"/>
                            </div>
                            <div class="audio">
