    ...
    <body onload="loadpage()" oncontextmenu="return false;">
            ...
            <section>
                <div class="row">
                    <div class="col-md-8 col-xs-12 ctbh">
                        <div class="ndchbdkt">
                            <form action="kiemtra" method="POST" enctype="multipart/form-data">                        
                                ...
                                ?> 
                                <input type="hidden" name="hv" id="hv" value="{{Auth::user()->id}}">
                                ...
                                @foreach ($ktra as $kt)  
                                    ...
                                    <input type="hidden" name="id_ch[{{$i}}]" value="{{$kt->id}}">
                                        <h2>Câu {{$i++}}:{{$kt->noidung}}</h2>                                    
                                    </div>
                                    <div class="">
                                        <p><input type="radio" name="luachon[{{$kt->id}}]" value="1">{{$kt->dapan1}}</p>
                                        <p><input type="radio" name="luachon[{{$kt->id}}]" value="2">{{$kt->dapan2}}</p>
                                        <p><input type="radio" name="luachon[{{$kt->id}}]" value="3">{{$kt->dapan3}}</p>
                                        <p><input type="radio" name="luachon[{{$kt->id}}]" value="4">{{$kt->dapan4}}</p>
                                    </div>
                                @endforeach
                                <div class="row">
        ...
        { 
            ...
            setTimeout(function() {
                ...
                window.open ("http://localhost:8000/kqkt/"+ idkq + "/"+bai);
            ...
            if(gcl * 1000 >y)
            {
                ...
                idhv = document.getElementById('hv').value;
                idkq = document.getElementById('idkq').value;
                bai = document.getElementById('bai').value;
                window.open ("http://localhost:8000/kqkt/"+ idkq + "/"+bai+"/"+idhv);
            }  
            else
            {
