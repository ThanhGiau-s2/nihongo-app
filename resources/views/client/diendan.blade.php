...
<html lang="en">
    ...
    <nav class="navbar navbar-inverse">
        ...
        <div class="container content">
            <div class="dd"><h3><a href="">Trang chủ</a> >>Diễn đàn</h3></div>
            <section>           
                <div class="row">                    
                    <div class="col-md-12 col-xs-12 diendan">                  
                        <div class="row hangbcc">
                            <div class="padding"><h3>Thông tin các kết quả cao nhất</h3></div>
                            <?php $i=0;?> 
                            <table class="table table-striped table-bordered table-hover" id="database">
                                        ...
                                        @foreach ($kqktbc as $l)                                     
                                            ...
                                            ?>
                                                ...
                                                <td class="center">{{$l->id_hv}}</td>                                                    
                                                <td class="center">{{$l->name}}</td> 
                                                <td class="center">{{$l->id_bai}}</td>    
                                                <td class="center">{{$l->ketqua}}</td>  
                    ...
                    <div class="row pb400">
                    <div class="col-md-12 col-xs-12 diendan">   
                    <div class="padding"><h3>Thông tin các kết quả mới nhất</h3></div>               
                        <div class="row hangbcc">   
                        <?php $i=1;?> 
                        <table class="table table-striped table-bordered table-hover" id="database">
                                        <thead>                                               
