    ...
    <body onload="loadpage()" oncontextmenu="return false;">
            ...
            <section>
                <div class="row">
                    <div class="col-md-8 col-8 ctbh">
                        <div class="ndchbdkt">
                            <form action="kiemtratv" method="POST" enctype="multipart/form-data">                        
                                    ...
                                    <div class="">
                                        ...
                                        <h2>Câu {{$i++}}:                                            
                                            <audio controls style="width: 300px;">
                                                <source src="upload/chtv/{{$kt->noidung}}" type="audio/mpeg">
                                            </audio>
                                        </h2>
                                    </div>
                                    <div class="">
        ...
        { 
            ...
            setTimeout(function() {
                ...
                window.open ("http://localhost:8000/kqkttv/"+ idkq + "/"+bai);
