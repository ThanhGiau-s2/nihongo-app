                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col mr-auto">
                                <h2 class="header-text">Danh sách kết quả kiểm tra từ vựng</h2>
                            </div>                            
                        </div>
                        <div class="card-body">                        
                            <div class="row">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="database">
                                        ...
                                        @foreach ($kqkttv as $b)                                     
                                            ...
                                            ?>
                                                ...
                                                <td>
                                                    <!-- <form method="get" action="admin/ketqua/deletekqkttv/{{$b->id_kqkttv}}" accept-charset="UTF-8" style="display:inline">
