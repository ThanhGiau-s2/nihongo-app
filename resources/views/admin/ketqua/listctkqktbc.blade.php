                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col mr-auto">
                                <h2 class="header-text">Danh sách chi tiết kết quả kiểm tra bài cũ</h2>
                            </div>
                        </div>
                        <div class="card-body">                        
                            <div class="row">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="database">
                                        ...
                                        @foreach ($kqktbc as $b)                                     
                                            <tr class="odd gradeX">
                                                ...
                                                <td>
                                                    <form method="get" action="admin/ctketqua/deletekqktbc/{{$b->id}}" accept-charset="UTF-8" style="display:inline">
