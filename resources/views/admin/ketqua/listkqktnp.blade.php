                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col mr-auto">
                                <h2 class="header-text">Danh sách kết quả kiểm tra ngữ pháp</h2>
                            </div>                            
                        </div>
                        <div class="card-body">                        
                            <div class="row">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="database">
                                        ...
                                        @foreach ($kqktnp as $b)                                     
                                            ...
                                            ?>
                                                ...
                                                <td>
                                                    <!-- <form method="get" action="admin/ketqua/deletekqktnp/{{$b->id_kqktnp}}" accept-charset="UTF-8" style="display:inline">
