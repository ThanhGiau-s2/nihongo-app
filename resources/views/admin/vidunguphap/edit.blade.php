    ...
    <div class="container-fluid">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form action="admin/vidunguphap/edit/{{$vidu_nps->id}}" method="POST">
                <input type="hidden" name="_token" value="{{csrf_token()}}"/>  
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">Sửa ví dụ</h5>                                
                    </div>
                    <div class="modal-body">                            
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <option value="{{$vidu_nps->id_np}}">{{$vidu_nps->id_np}}</option>                                            
                                    @foreach($npsa as $np)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="tiengnhat" class="form-control" value="{{$vidu_nps->tiengnhat}}">                                            
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="tiengviet" class="form-control" value="{{$vidu_nps->tiengviet}}">                                            
                    ...
                    <div class="modal-footer">
                        ...
                        <a type="" href="admin/vidunguphap/list" class="btn btn-secondary">Trở về</a>
                    </div>
                </form>
            </div>
        </div>
