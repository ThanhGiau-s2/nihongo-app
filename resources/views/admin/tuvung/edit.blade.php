    ...
    <div class="container-fluid">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form action="admin/tuvung/edit/{{$tuvungs->id}}" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="{{csrf_token()}}"/>  
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">Sửa từ vựng</h5>                                
                    </div>
                    <div class="modal-body">   
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <option value="{{$tuvungs->id_bai}}">{{$tuvungs->id_bai}}</option>                                            
                                    @foreach($baisa as $b)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="hiragana" class="form-control" placeholder="Hiragana" value="{{$tuvungs->hiragana}}">                                            
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="hantu" class="form-control" placeholder="Hán tự" value="{{$tuvungs->hantu}}">                                            
                                @if ($errors->has('hantu'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="nghia" class="form-control" placeholder="nghia" value="{{$tuvungs->nghia}}">                                            
                                @if ($errors->has('nghia'))
