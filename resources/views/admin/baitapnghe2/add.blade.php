    ...
    <div class="container-fluid">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form action="admin/btn2/add" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="{{csrf_token()}}"/>  
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">Thêm bài tập nghe 2</h5>                                
                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <a type="" href="admin/btn2/list" class="btn btn-secondary">Trở về</a>
                    </div>
                </form>
            </div>
        </div>
