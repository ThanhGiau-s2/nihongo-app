                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col mr-auto">
                                <h2 class="header-text">Danh sách câu hỏi</h2>
                            </div>
                            <div class="col-sm-1" id="header-btn-add">
                                <a href="admin/cauhoi/add" type="" class="btn btn-add btn-primary">Thêm</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-12">
                                        <a href="admin/cauhoi/downloadExcelSample"><button class="btn btn-success">Tải tập tin mẫu</button></a>                   
                                    </div>
                                </div>
                                <form style="margin-top: 15px;margin-bottom:20px;" action="admin/cauhoi/importExcel" class="form-horizontal" method="post" enctype="multipart/form-data">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="database">
                                        ...
                                        @foreach ($cauhois as $ch)                                     
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="center">
                                                <a href="admin/cauhoi/edit/{{$ch->id}}"><i class="fa fa-edit text-success"></i></a>
                                                    <form method="get" action="admin/cauhoi/delete/{{$ch->id}}" accept-charset="UTF-8" style="display:inline">
