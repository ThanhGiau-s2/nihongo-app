...
@section('content')
    ...
    <div class="container-fluid">
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <form action="admin/ctbtn2/add" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="{{csrf_token()}}"/>  
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">Thêm đáp án bài tập nghe 2</h5>                                
                    </div>
                    <div class="modal-body">    
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Câu hỏi bài:</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="noidung" class="form-control" type="text" placeholder="Nội dung">                                            
