    ...
    <div class="container-fluid">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form action="admin/bangchucaichitiet/add" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="{{csrf_token()}}"/>  
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">Thêm chữ cái</h5>                                
                    </div>
                    <div class="modal-body">    
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Hiragana:<span id="required">*</span></label>
                            <div class="col-sm-9">
                                <input name="hira" class="form-control" type="text">                                            
                                @if ($errors->has('hira'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="kata" class="form-control" type="text">                                            
                                @if ($errors->has('kata'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="romaji" class="form-control" type="text">                                            
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <option value="0">Vui lòng chọn loại</option>                                            
                                    @for($i=1;$i<3;$i++ )
